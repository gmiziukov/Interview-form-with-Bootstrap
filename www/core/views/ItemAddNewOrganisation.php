...
<div class="container">
    <ul class="nav nav-justified">
        <li class="active"><a href="<?php echo $_SERVER['PHP_SELF']."?view=ItemAddNewOrganisation"; ?>">Добавление организаций</a></li>
    ...
    <div class="form-interview">
        ...
        <form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <div class="form-group">
                <label for="OrganisationName" class="control-label">Наименование новой организации:</label>
                <input type="text" class="form-control" id="OrganisationName" name="organisationName" maxlength="250" required />
            </div>
            <input class="btn btn-primary" type="submit" name="btn" value="Добавить" />
            <input type="hidden" name="view" value="ItemAddNewOrganisation" />
            <input type="hidden" name="isAddOrganisation" value="true" />
        </form>
    </div>
</div>
<div id="footer">
