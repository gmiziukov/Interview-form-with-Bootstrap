...
<div class="container">
    <ul class="nav nav-justified">
        ...
        <li class="active"><a href="<?php echo $_SERVER['PHP_SELF']."?view=ItemPacketLoad"; ?>">Пакетная загрузка</a></li>
    </ul>
</div>
<div class="container">
    <div class="form-interview">
        <div class="alert alert-success <?php echo $successInsertBox; ?>" role="alert">
            <strong>Сообщение!</strong> Данные успешно загружены!
        </div>
        <div class="alert alert-danger <?php echo $errorInsertBox; ?>" role="alert">
            <strong>Ошибка!</strong> Произошла ошибка вовремя загрузки данных в базу данных!
        </div>
        <form role="form" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <input class="btn btn-primary" type="submit" name="btn" value="Загрузить" />
            <input type="hidden" name="view" value="ItemPacketLoad" />
