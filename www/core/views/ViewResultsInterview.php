    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?php echo $_SERVER['PHP_SELF']."?view=ViewResultsInterview"; ?>">Просмотр результатов</a></li>
            </ul>
    ...
    <div class="form-interview">
        ...
        if(!isset($_GET['idInterview']) && empty($_GET['idInterview']))
        {
            foreach($arrayOrganisations as $itemOrganisation)
            {
                ...
                <?php
                foreach($arrayAllInterview as $itemInterview)
                {
                    if($itemOrganisation['IdOrganisation'] == $itemInterview['IdOrganisationFK'])
                    {
                        ?>
                        <div class="form-group">
                            <a href="<?php echo $_SERVER['PHP_SELF']."?idInterview="?><?php echo $itemInterview['IdInterview']; ?>&view=ViewResultsInterview">
        ...
        {
            require_once __DIR__.'/../controls/ManageResults.php';
        }
        ?>
    </div>
</div>
